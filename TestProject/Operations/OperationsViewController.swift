    ...
    
{
    ...
    override func viewDidLoad()
    {
        ...
        tableView.register(UINib(nibName: "OperationViewCell", bundle: nil), forCellReuseIdentifier: identifier)
        self.getOperation()
    }
...
extension OperationsViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: identifier, for: indexPath) as! OperationViewCell
